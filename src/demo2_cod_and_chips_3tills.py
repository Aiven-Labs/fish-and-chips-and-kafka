...
"""demo2_cod_and_chips_3tills.py - A model of a very simple fish and chips shop

Now we have 3 tills, but still only one food preparer.

Note: writes log messages to the file demo2.log.
"""
...
class MyGridApp(App):
    ...
    def compose(self) -> ComposeResult:
        ...
        producer1 = TillWidget('Till 1', self.kafka_uri, self.ssl_context, self.topic_name)
        producer2 = TillWidget('Till 2', self.kafka_uri, self.ssl_context, self.topic_name)
        producer3 = TillWidget('Till 3', self.kafka_uri, self.ssl_context, self.topic_name)
